...
**[Sign Language Translator](https://github.com/Ankan-7/Sign-Language-Translator)**

A machine learning-based system that translates hand gestures into text using real-time input.

**[AI Interview Evaluator](https://github.com/Ankan-7/AI-Interview-Evaluator)**

An NLP-based system designed to analyze and evaluate candidate responses.

## Tech Stack

Python, Scikit-learn, Flask, OpenCV, MediaPipe, Git & GitHub
